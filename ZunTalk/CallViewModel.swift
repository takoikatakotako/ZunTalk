...
class CallViewModel: ObservableObject {
    ...
    init(voicevoxRepository: TextToSpeechRepository = VoicevoxRepository()) {
    ...
    func onAppear() {
        ...
        Task {
            do {
                ...
                let data = try await voicevoxRepository.synthesize(text: "こんにちは、ずんだもんなのだ！")
...
//                    
//                    // 音声合成を実行
//                    self.synthesizeSpeech(text: result.bestTranscription.formattedString)
//                }
//            }
//                    
